...
enum RawMaterialMovementType: string
{
    ...
    {
        return match ($this) {
            self::RECEIPT        => 'fa-arrow-right-to-bracket',
            self::ISSUE          => 'fa-arrow-right-from-bracket',
            self::TRANSFER_IN    => 'fa-right-left',
            self::TRANSFER_OUT   => 'fa-exchange-alt',
            self::ADJUSTMENT_IN  => 'fa-plus',
            self::ADJUSTMENT_OUT => 'fa-minus',
        };
    }
