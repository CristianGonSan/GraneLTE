...
@section('content')
    <h1 class="h4">Detalles de almacén</h1>
    <livewire:Inventory.Warehouses.WarehouseShow :warehouseId="$warehouseId" />
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-stocks" role="tabpanel" aria-labelledby="pills-stocks-tab">
            <livewire:Inventory.Warehouses.StocksTable :warehouseId="$warehouseId" />
        </div>

        <div class="tab-pane fade" id="pills-movements" role="tabpanel" aria-labelledby="pills-movements-tab">
            <livewire:Inventory.Warehouses.MovementsTable :warehouseId="$warehouseId" lazy />
        </div>
    </div>
