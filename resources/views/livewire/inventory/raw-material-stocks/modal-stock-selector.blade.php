<div>
    <div wire:ignore.self id="modalRawMaterialStockSelector" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modalRawMaterialStockSelectorLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">

                {{-- Header --}}
                <div class="modal-header py-2">
                    <h6 class="modal-title font-weight-bold mb-0" id="modalRawMaterialStockSelectorLabel">
                        ...
                        <div class="col-md-12">
                            <div class="input-group input-group-sm">
                                <input type="text" name="search_input" class="form-control"
                                    placeholder="Buscar por material, almacén o lote..." wire:keydown.enter="search"
                                    wire:loading.attr="readonly" wire:target="search" wire:model="searchTerm">
                        ...
                        <div class="form-group col-md-4 col-6 mb-0">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                @if ($filters['expirationFilter'] === 'expiring')
                                    <input type="number" name="expiration_days" class="form-control" min="1"
                                        step="1" wire:model.live.debounce.600ms="filters.expirationDays"
                        ...
                        <div class="list-group list-group-flush pt-1 pl-1">
                            @foreach ($stocks as $stock)
                                ...
                                <div class="list-group-item list-group-item-action mb-2 rounded shadow-sm cursor-pointer"
                                    ...
                                    wire:click="selectStock({{ $stock->id }})">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-right" style="min-width: 140px;">
                                            <div>
                                                <strong class="{{ $quantityClass }}" style="font-size: 1.1rem;">
                                                    {{ number_format($qty, 3) }}
                                                </strong>
                                            </div>
                                            <div>
...
@push('js')
    <script>
        Livewire.on('showModalRawMaterialStockSelector', function() {
            $('#modalRawMaterialStockSelector').modal('show');
        });

        Livewire.on('hideModalRawMaterialStockSelector', function() {
            $('#modalRawMaterialStockSelector').modal('hide');
        });
    </script>
@endpush
