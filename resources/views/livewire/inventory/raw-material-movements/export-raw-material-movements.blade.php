    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <x-adminlte-select name="movementType" label="Tipo de movimiento" fgroup-class="col-md-3"
                    class="custom-select" wire:model="movementType">
            ...
            <div class="row">
                <x-adminlte-input name="quantityMin" label="Cantidad (mín.)" type="number" fgroup-class="col-md-2"
                    min="0" step="0.001" placeholder="-∞" wire:model="quantityMin" />

                <x-adminlte-input name="quantityMax" label="Cantidad (máx.)" type="number" fgroup-class="col-md-2"
                ...
                <x-adminlte-input name="effectiveFrom" label="Fecha efectiva desde" type="datetime-local"
                    fgroup-class="col-md-4" wire:model="effectiveFrom" />

                <x-adminlte-input name="effectiveTo" label="Fecha efectiva hasta" type="datetime-local"
                    fgroup-class="col-md-4" wire:model="effectiveTo" />
            </div>
