<div>
    <form wire:submit="save">
        <div class="card">
            <div class="card-body form-row">
                ...
                <x-adminlte-input fgroup-class="col-md-4" class="text-uppercase" name="abbreviation"
                    ...
                    maxlength="8" title="Se usara como prefijo en el codigo de los lotes" :readonly="$hasBatches" required />

                <x-adminlte-input fgroup-class="col-md-4" name="minimum_stock" label="Stock mínimo" placeholder="0.000"
                    type="number" step="0.001" wire:model="minimum_stock" />
        ...
        <div class="mb-3">
            ...
            <a href="{{ route('raw-materials.show', $rawMaterialId) }}" class="btn btn-outline-secondary"
