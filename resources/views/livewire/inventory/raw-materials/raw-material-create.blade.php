<div>
    ...
    <form wire:submit.prevent="save">
        <div class="card">
            <div class="card-body form-row">
                <x-adminlte-input fgroup-class="col-md-4" name="name" label="Nombre *"
                    placeholder="Ingrese el nombre de la materia prima" type="text" wire:model="name" maxlength="128"
                    required autofocus />

                <x-adminlte-input fgroup-class="col-md-4" class="text-uppercase" name="abbreviation"
                    label="Abreviatura *" placeholder="Ej: MAIZ, MAIZ-B, HENO" type="text" wire:model="abbreviation"
                    maxlength="8" title="Se usara como prefijo en el codigo de los lotes" required />

                <x-adminlte-input fgroup-class="col-md-4" name="minimum_stock" label="Stock mínimo" placeholder="0.000"
                    type="number" step="0.001" min="0" wire:model="minimum_stock" />
                ...
                <x-adminlte-textarea fgroup-class="col-md-12" name="description" label="Descripción"
                    placeholder="Ingrese una descripción..." wire:model="description" rows="3" maxlength="255" />
                ...
                <div class="col-12">
                    <x-checkbox name="createAnother" label="Guardar y crear otra"
                        title="Permite ingresar otra materia prima después de guardar" wire:model="createAnother" />
                </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <a href="{{ route('raw-materials.index') }}" class="btn btn-outline-secondary" wire:loading.attr="disabled">
                Cancelar
            </a>
        </div>
    </form>
