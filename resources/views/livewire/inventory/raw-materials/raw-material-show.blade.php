        ...
        <div class="mb-3">
            ...
            @can('raw-materials.delete')
                <x-livewire.loading-button label="Eliminar" theme="outline-danger" class="mr-1" icon="trash"
                    wire:click="delete" wire:target="delete" wire:swal-confirm="¿Eliminar esta materia prima?"
                    swal-icon="warning" :disabled="$isInUse" :title="$isInUse ? 'No se puede eliminar: la materia prima está en uso' : ''" />
            @endcan
