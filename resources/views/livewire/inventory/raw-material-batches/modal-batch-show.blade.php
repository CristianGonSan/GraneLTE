<div>
    <div wire:ignore.self id="modalRawMaterialBatchShow" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modalRawMaterialBatchShowLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="h4 modal-title" id="modalRawMaterialBatchShowLabel">Detalles de lote</h1>
                ...
                @if ($batch)
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-sm-8 mb-0">{{ $material->category->mediumText('name') }}</dd>
                                </dl>
                            </div>
                        </div>
                        ...
                        <h2 class="h5">
                            Proveedor
                            @can('suppliers.view')
                                <a href="{{ route('suppliers.show', $supplier->id) }}" target="_blank">
                                    <i class="fas fa-fw fa-arrow-up-right-from-square"></i>
                                </a>
                            @endcan
                        </h2>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <dl class="row mb-0">
                                    <dt class="col-sm-4 text-muted">Nombre</dt>
                                    <dd class="col-sm-8">{{ $supplier->mediumText('name') }}</dd>

                                    <dt class="col-sm-4 text-muted">Descripción</dt>
                                    <dd class="col-sm-8 text-muted mb-0">
                                        {{ $supplier->longText('description', 'Sin descripción') }}
                                    </dd>
                                </dl>
                            </div>
                        </div>
...
@push('js')
    <script>
        Livewire.on('showModalRawMaterialBatchShow', function() {
            $('#modalRawMaterialBatchShow').modal('show');
        });

        Livewire.on('hideModalRawMaterialBatchShow', function() {
            $('#modalRawMaterialBatchShow').modal('hide');
        });
    </script>
@endpush
